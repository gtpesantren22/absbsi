          ...
          <section class="content">
              ...
              <div class="box">
                  <div class="box-header">
                      <h3 class="box-title text-primary">Absensi Pembiasaan Guru</h3>
                      <!-- <button class="btn btn-sm btn-primary pull-right" onclick="window.location='<?= base_url('pembiasaan/input') ?>'">Buat Absen</button> -->
                      <div class="btn-group pull-right">
                          <button onclick="window.location.href='<?= base_url('pembiasaan/apelSett') ?>'" type="button" class="btn btn-warning"><i class="fa fa-cog"></i> Setting Kehadiran</button>
                          <button onclick="window.location.href='<?= base_url('pembiasaan/input_apel') ?>'" type="button" class="btn btn-primary">Input Absensi</button>
                      </div>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
