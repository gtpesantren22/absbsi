                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              ...
                                              <label class="custom-radio">
                                                  <input type="radio" name="data[<?= $no ?>][ket]" disabled value="hadir" <?= $ck ?>>
                                                  <span class="custom-radio-label success">H</span>
                                              </label>
                                              <label class="custom-radio">
                                                  <input type="radio" name="data[<?= $no ?>][ket]" disabled value="sakit" <?= $row->izin != 0 ? 'checked' : '' ?>>
                                                  <span class="custom-radio-label warning">S</span>
                                              </label>
                                              <label class="custom-radio">
                                                  <input type="radio" name="data[<?= $no ?>][ket]" disabled value="izin" <?= $row->sakit != 0 ? 'checked' : '' ?>>
                                                  <span class="custom-radio-label primary">I</span>
                                              </label>
                                              <label class="custom-radio">
                                                  <input type="radio" name="data[<?= $no ?>][ket]" disabled value="alpha" <?= $row->alpha != 0 ? 'checked' : '' ?>>
